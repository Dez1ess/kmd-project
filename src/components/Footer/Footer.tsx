      ...
      <Container>
        <div className="footer-links">
          <div className="contact-us-main">
            ...
            <div className="links">
              <p><a href="#!">098 900 09 09</a></p>
              <p><a href="#!">Пн - Пт 09:00 - 21:00</a></p>
              <p><a href="#!">Пн - Пт 09:00 - 21:00</a></p>
            </div>
          </div>
          <div className="contact-us-links">
            <div className="contact-us">
              ...
              <div className="links">
                <p><a href="#!">Оплата і доставка</a></p>
                <p><a href="#!">Повернення</a></p>
                <p><a href="#!">Питання та відповіді</a></p>
              </div>
            </div>
            <div className="contact-us">
              <p className="links-subheader">Особистий кабінет</p>
              <div className="links">
                <p><a href="#!">Мої дані</a></p>
                <p><a href="#!">Історія замовлень</a></p>
                <p><a href="#!">Улюблені</a></p>
                <p><a href="#!">Розсилки</a></p>
              </div>
            </div>
            <div className="contact-us">
              ...
              <div className="links">
                ...
                <p><a href="#!">Угода користувача</a></p>
              </div>
            </div>
          </div>
        </div>
